...
import {
  ScatterChart, Scatter, XAxis, YAxis, CartesianGrid, Tooltip, LabelList, ResponsiveContainer, Customized,
  Cross
} from 'recharts';
...
const data = [
  ...
  { x: 120, y: 100, z: "Information" },
  { x: 170, y: 300, z: "trade/Trans/UT" },
  { x: 140, y: 250, z: "Government" },
  { x: 150, y: 400, z: "Manufacturing" },
  { x: 110, y: 280, z: "Prof/Bus" },
];
